...
print('━' * 63)
logo = render('file by', font='block', colors=['white', 'black'], align='center', background='red' , space=True)
print(logo)
...
def tinfo():
    tln = "                🗣️📢 𝗨𝗟𝗧𝗜𝗠𝗔𝗧𝗘 𝗠𝗘𝗧𝗔 𝗧𝗢𝗢𝗟 🗣️📢                       "
    for char in tln:
        sys.stdout.write('\033[30m' + '\033[43m' + char)
        sys.stdout.flush()
        time.sleep(0.0200)
    print('\n' + '\033[0m━' * 63)
...
'''
    with open("hazypyhits.txt", "a", encoding='utf-8') as file:
        file.write(ss + "\n")
        try:
